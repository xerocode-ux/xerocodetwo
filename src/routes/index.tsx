...
function Index() {
  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <main className="mx-auto flex w-full max-w-md flex-1 flex-col items-center px-5 pb-14 pt-16 text-center">
        ...
        <div className="mt-4 inline-flex items-center gap-2 rounded-full border border-primary/50 px-5 py-2 text-xs font-bold tracking-[0.15em] text-primary">
        ...
        <a
          href={WHATSAPP_URL}
          className="cta-gradient mt-7 flex w-full items-center justify-center gap-2 rounded-full px-6 py-4 text-lg font-bold text-primary-foreground transition-transform hover:scale-[1.02]"
        >
        ...
        <div className="mt-4 w-full rounded-2xl border border-border/70 bg-card px-5 py-4">
          <p className="text-sm text-muted-foreground">
            Opening WhatsApp in <span className="font-bold text-gold">{seconds}s</span> — or tap
            above
          </p>
        ...
        <p className="mt-6 text-xs leading-relaxed text-muted-foreground">
          Joining the channel is free. Results and earnings from any task can vary and are not
          guaranteed. Please do your own research before proceeding.
        </p>
      </main>
    </div>
  );
